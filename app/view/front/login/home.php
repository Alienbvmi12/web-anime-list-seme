<section id="main-section" class="vh-100 mt-lg-0 bg-soft d-flex align-items-center">
    <div class="container">
        <form id="main-form">
            <div class="row justify-content-center form-bg-image">
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500" style="background:rgba(255, 255, 255, 0.9)">
