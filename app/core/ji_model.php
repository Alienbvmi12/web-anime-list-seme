                ...
                if (isset($data[$key])) {
                    if ($tmp[0] === 'max') {
                        if (strlen((string)$param) > $tmp[1]) {
                            return [
                                "result" => false,
                                "message" => '"' . $keyAs . '" lenght must not be more than '. $tmp[1] .' character '
                            ];
                            die;
                        }
                    }
                    if ($tmp[0] === 'min') {
                        if (strlen((string)$param) < $tmp[1]) {
                            return [
                                "result" => false,
                                "message" => '"' . $keyAs . '" length must not be less than ' . $tmp[1] .' character '
                            ];
                            die;
                        }
                    }
                    ...
                    if ($tmp[0] === 'unique') {
                        ...
                        if ($checkTbl > 0) {
                            return [
                                "result" => false,
                                "message" => '"' . $key . '" cannot be same as the other "' . $keyAs . '"'
                            ];
                            die;
                        }
                    }
